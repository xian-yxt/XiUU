...
LoadingBarConstructor.prototype.start = function () {
  this.init();
  timer = setInterval(() => {
    if (this.totalProgress < 90) this.totalProgress += (this.percentNum || Math.random()) * this.speed;
  }, 100);
};
