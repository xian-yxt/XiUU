    ...
    >
      ...
      <template v-for="item in tableColumns">
        <el-table-column
          ...
          :key="item.key"
          :prop="item.key"
          :label="item.title | NAME_SPACE_FORMAT"
          :width="item.width"
          :align="item.align"
          :fixed="item.fixed"
      ...
      <el-table-column
        v-if="showAction"
        :label="actionQuery.label | NAME_SPACE_FORMAT"
...
<script>
import ElTable from '@fm/elementui/table';
import ElPagination from '@fm/elementui/pagination';
